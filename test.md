...
The modal displays all available layers:
...
When a layer is toggled ON, it appears on the map.
...
The Townlands toggle is disabled.

A tooltip icon appears explaining the restriction.
...
The Townlands toggle becomes enabled.
...
The map is zoomed (while still ≥ 12)
